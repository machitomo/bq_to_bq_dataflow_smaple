...
public class BqDataAddNumber {
    ...
    static void runBqDataAddNumber(BqDataAddNumberOptions options) throws IOException {
        ...
        PCollection<TableRow> inputRows = p.apply("ReadFromBQ", BigQueryIO.readTableRows().fromQuery(query));
    ...
    public static void main(String[] args) throws IOException {
		// 実行オプションの作成
        BqDataAddNumberOptions options = PipelineOptionsFactory.fromArgs(args).withValidation().as(BqDataAddNumberOptions.class);
